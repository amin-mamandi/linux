 ...
 */
 ...
 /* Define Svpbmt deterministic memory type (reserved value 11) */
 #define _PAGE_DETMEMORY_SVPBMT (3UL << 61)  /* Using reserved value 11 for detmem */
 #define _PAGE_DETMEM_SVPBMT    _PAGE_DETMEMORY_SVPBMT
 
 /* Define T-Head deterministic memory type */
 #define _PAGE_DETMEMORY_THEAD  ((1UL << 63) | (1UL << 60))  /* SO and SH bits set */
 #define _PAGE_DETMEM_THEAD     _PAGE_DETMEMORY_THEAD
  ...
  * 10010 - DETMEM  Strongly-ordered, Non-cacheable, Non-bufferable, Shareable, Non-trustable

  try this later:
  00010 - Weakly-ordered, Non-cacheable, Non-bufferable, Shareable, Non-trustable
  #define _PAGE_DETMEMORY_THEAD  (1UL << 60)  Only SH bit set 
